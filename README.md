...
The current build functions as intended, however I do intend to add more integral business related queries to the queries.md file and the Date_Theory.md file to showcase and improve my capabilities with SQLite.
